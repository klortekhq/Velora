...
- Release metadata is synchronized at source version 1.2.47 across Android, webOS,
...
Release `v1.2.47` is prepared from person-navigation/i18n/home-localization fixes; its Android and web workflows are the
