...
- Release metadata is synchronized at source version 1.2.64 across Android, webOS,
...
The current source is version `1.2.64`. Android mobile/TV release APKs and the
