...
- Release metadata is synchronized at source version 1.2.25 across Android, webOS,
...
- Release `v1.2.25` contains the adaptive login-layout, tactile seek, and subtitle-preservation fixes; its Android and
