...
La etiqueta `v1.2.79` ya está publicada en `main`; sus workflows de release están
...
- Release metadata is synchronized at source version 1.2.79 across Android, webOS,
...
## Release actual: v1.2.79 (preparación)

La fuente actual es `1.2.79`. Incluye las correcciones de presentación para el
