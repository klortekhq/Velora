...
- Release metadata is synchronized at source version 1.2.65 across Android, webOS,
...
The current source is version `1.2.65`. Android mobile/TV release APKs and the
