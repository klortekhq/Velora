...
La etiqueta `v1.2.78` ya está publicada en `main`; sus workflows de release están
...
- Release metadata is synchronized at source version 1.2.78 across Android, webOS,
...
## Release actual: v1.2.78 (preparación)

La fuente actual es `1.2.78`. Incluye las correcciones de presentación para el
