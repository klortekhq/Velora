...
import com.flex.elefin.continuewatching.ContinueWatchingDismissStore
                    ...
                    TabRow(
                        ...
                        allTabs.forEachIndexed { index, (tabName, itemId) ->
                            ...
                            val itemName = if (isCollectionsTab) {
                                androidx.compose.ui.res.stringResource(com.flex.elefin.R.string.collections)
                            } else {
                        ...
                        if (continueWatchingItems.isNotEmpty()) {
                            item(key = "continue_watching", contentType = "media_row") {
                                Column(
                                    ...
                                    Text(
                                        text = androidx.compose.ui.res.stringResource(com.flex.elefin.R.string.continue_watching),
                                        style = MaterialTheme.typography.headlineMedium.copy(
                                            fontSize = MaterialTheme.typography.headlineMedium.fontSize * 0.64f
                                        ),
                        ...
                        if (nextUpItems.isNotEmpty()) {
                            item(key = "next_up", contentType = "media_row") {
                                ...
                                Column(
                                    ...
                                    Text(
                                        text = androidx.compose.ui.res.stringResource(com.flex.elefin.R.string.next_up),
                                        style = MaterialTheme.typography.headlineMedium.copy(
                                            fontSize = MaterialTheme.typography.headlineMedium.fontSize * 0.64f
                                        ),
                        ...
                        movieLibraries.forEachIndexed { index, library ->
                            ...
                            if (libraryMovies.isNotEmpty()) {
                                item(key = "recently_added_movies_${library.Id}", contentType = "media_row") {
                                    ...
                                    val rowTitle = if (index == 0) androidx.compose.ui.res.stringResource(com.flex.elefin.R.string.recently_added_movies) else androidx.compose.ui.res.stringResource(com.flex.elefin.R.string.recently_added_named, library.Name)
                                    Column(
                                        modifier = Modifier
                                            .then(
                                                if (isFirst) {
                        ...
                        if (recentlyReleasedMovies.isNotEmpty()) {
                            item(key = "recently_released_movies", contentType = "media_row") {
                                ...
                                Column(
                                    ...
                                    Text(
                                        text = androidx.compose.ui.res.stringResource(com.flex.elefin.R.string.recently_released_movies),
                                        style = MaterialTheme.typography.headlineMedium.copy(
                                            fontSize = MaterialTheme.typography.headlineMedium.fontSize * 0.64f
                                        ),
                                        modifier = Modifier.padding(bottom = 12.dp, top = if (isFirst) 12.dp else 30.36.dp)
                        ...
                        tvShowLibraries.forEachIndexed { libraryIndex, library ->
                            ...
                            if (libraryShows.isNotEmpty()) {
                                item(key = "recently_added_shows_${library.Id}", contentType = "media_row") {
                                    ...
                                    val rowTitle = if (libraryIndex == 0) androidx.compose.ui.res.stringResource(com.flex.elefin.R.string.recently_added_shows) else androidx.compose.ui.res.stringResource(com.flex.elefin.R.string.recently_added_shows_in, library.Name)
                                    Column(
                                        modifier = Modifier
                                            .then(
                                                if (isFirst) {
                        ...
                        tvShowLibraries.forEachIndexed { libraryIndex, library ->
                            ...
                            if (libraryEpisodes.isNotEmpty()) {
                                item(key = "recently_added_episodes_${library.Id}", contentType = "media_row") {
                                    ...
                                    val rowTitle = if (libraryIndex == 0) androidx.compose.ui.res.stringResource(com.flex.elefin.R.string.recently_added_episodes) else androidx.compose.ui.res.stringResource(com.flex.elefin.R.string.recently_added_episodes_in, library.Name)
                                    Column(
                                        modifier = Modifier
                                            .then(
                                                if (isFirst) {
