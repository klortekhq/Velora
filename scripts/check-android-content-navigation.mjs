...
assert.match(liveTvActivity, /onPlay\(selected,\s*liveTvPlaybackChannelList\(visibleGroups, group, selected\)\)/, 'La fuente elegida debe conservarse en la lista filtrada de zapping y reproducción.');
